...
#include <float.h>
#include <primitive_mesh/predicates.h>
...
/*  If `xi' is NULL on input, the xi-eta coordinates will not be computed.   */
/*																			 */
/* corrected by siegel pascal janvier 2000 colenco                           */
/*                                                                           */
/*****************************************************************************/
...
// rajout de fonction pour les rendres compatibles avec les object utilis�s


//-----------------------------------------------------------
// fonction qui determine si 4 points forme
// un tetraedre bien oriente
// retourne 0 si les 4 points sont coplanaire
// une valeur positive si les point sont bien orientes
// (convention de george)
// negative si ils ne sont pas orientes correctement 
//------------------------------------------------------------

double Orient3D(Point3D tpa,Point3D tpb,Point3D tpc,Point3D tpd) 
{
	double orient=-orient3d(tpa.vector().data(), tpb.vector().data(), tpc.vector().data(), tpd.vector().data());
...
//----------------------------------------------------------
// fonction qui determine si 3 points forme
// un triangle bien oriente
// retourne 0 si les 3 points sont colineaire
// une valeur positive si les point sont bien orientes
// negative si ils ne sont pas orientes correctement 
//-----------------------------------------------------------
...
{
	return orient2d(tpa.vector().data(), tpb.vector().data(), tpc.vector().data());
